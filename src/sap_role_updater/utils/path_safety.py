...
from sap_role_updater.utils.error_handler import raise_error
from sap_role_updater.utils.settings import DEFAULT_LIMITS as SETTINGS_DEFAULT_LIMITS

DEFAULT_LIMITS = SETTINGS_DEFAULT_LIMITS
